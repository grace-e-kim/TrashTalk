  ...
  return (
    <>
      ...
      <SafeAreaView>
        ...
        { currentScreen === 'messages' ? <ChatRoom Auth={auth} getLocation={getLocation} CurrentLocation={currentLocation} updateScreen={updateScreen} RoomCode={roomCode} RoomUsers={roomUsers} Messages={roomMessages} /> : null }
      </SafeAreaView>
    </>
  );
};
