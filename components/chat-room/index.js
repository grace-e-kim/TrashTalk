        ...
        <View style={styles.innerContainer}>
          ...
          <View style={styles.newMessage}>
            <TextInput
              ...
              value={messageText}
              onChangeText={text => {setMessageText(text); updateLocation(); setTypingStatus(true); typing()}}
              multiline={true}
              onSubmitEditing={() => submitMessage()}
              returnKeyType="done"
              blurOnSubmit={true}
              />
            <TouchableOpacity style={styles.addIcon} onPress={() => {submitMessage(); setTypingStatus(false); typing()}}>
